...
export const Menu = ({ setActive, children }) => {
  return (
    ...
    className="relative rounded-full border border-transparent dark:bg-black/30 dark:border-white/20 bg-white/30 backdrop-blur-md shadow-lg flex justify-center space-x-4 px-8 py-6">
    {children}
    </nav>
